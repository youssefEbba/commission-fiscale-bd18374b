    ...
    <DashboardLayout>
      <div className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="p-4">
              <p className="text-xs text-muted-foreground mb-1">{t("mise_en_place:detail.info.autorite")}</p>
              <p className="font-semibold">{autorite?.nom || (c as any).autoriteContractanteNom || "—"}</p>
              {(autorite?.ministereTutelleNom || (c as any).autoriteContractanteMinistereTutelleNom) && (
                <p className="text-xs text-muted-foreground">{autorite?.ministereTutelleNom || (c as any).autoriteContractanteMinistereTutelleNom}</p>
              )}
            </CardContent>
          </Card>
