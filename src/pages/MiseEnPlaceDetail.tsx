...
import {
  ...
  AlertTriangle, History, DollarSign, Upload, MessageSquare, Send, Info,
} from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 max-w-5xl mx-auto">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                <div><span className="text-muted-foreground">Cordon (enveloppe)</span><p className="font-bold">{c.montantCordon?.toLocaleString("fr-FR") || "—"} MRU</p></div>
                ...
                <div><span className="text-muted-foreground">Solde Cordon (droits)</span><p className="font-bold">{c.soldeCordon?.toLocaleString("fr-FR") || "—"} MRU</p></div>
                <div><span className="text-muted-foreground">TVA Intérieure</span><p className="font-bold">{c.montantTVAInterieure?.toLocaleString("fr-FR") || "—"} MRU</p></div>
        ...
        {/* Récapitulatif fiscal (a, b, d, e=b+d, f, g, h=g-d, total) */}
            ...
            <CardContent className="p-0">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow className="bg-muted/40"><TableCell className="font-mono font-bold">h</TableCell><TableCell className="font-semibold">Crédit intérieur net (g − d accord)</TableCell><TableCell className="text-right font-bold">{c.creditInterieurNetRecap?.toLocaleString("fr-FR") ?? "—"}</TableCell></TableRow>
