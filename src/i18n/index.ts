...
import frSousTraitance from "./locales/fr/sous_traitance.json";
...
import arSousTraitance from "./locales/ar/sous_traitance.json";
...
import arPresentation from "./locales/ar/presentation.json";
...
const resources = {
  fr: {
    ...
    sous_traitance: frSousTraitance,
  ...
  ar: {
    ...
    sous_traitance: arSousTraitance,
