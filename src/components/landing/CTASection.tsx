      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <div className="relative">
            <h2 className="mb-4 text-3xl font-extrabold text-primary-foreground md:text-4xl">{t("cta.title")}</h2>
            <p className="mb-3 text-lg font-semibold text-gold">{t("cta.kicker")}</p>
            <p className="mx-auto mb-10 max-w-lg text-primary-foreground/70">{t("cta.subtitle")}</p>
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Button size="lg" className="bg-gold text-accent-foreground font-semibold text-base px-8 hover:bg-gold-light gap-2" asChild>
                <Link to="/register">{t("cta.primary")} <ArrowRight className="h-4 w-4 rtl:rotate-180" /></Link>
              </Button>
              <Button size="lg" variant="outline" className="border-primary-foreground/20 text-primary-foreground bg-transparent hover:bg-primary-foreground/10 font-semibold text-base px-8 gap-2" asChild>
                <Link to="/login"><Phone className="h-4 w-4" /> {t("cta.secondary")}</Link>
              </Button>
            </div>
          </div>
        </motion.div>
