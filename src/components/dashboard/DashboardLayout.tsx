...
import { Users, LayoutDashboard, LogOut, FileText, Award, Settings, ChevronDown, Tag, Landmark, ArrowRightLeft, Archive, BarChart3, Menu, X, FolderOpen, ScrollText, FlaskConical, User, CircleUser, Gavel, UserPlus, Handshake, PieChart, ShieldCheck, AlertTriangle, Loader2, Wand2 } from "lucide-react";
...
const NAV_ENTRIES: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { labelKey: "injection_certificats", href: "/dashboard/admin/injection-certificats", icon: Wand2 },
